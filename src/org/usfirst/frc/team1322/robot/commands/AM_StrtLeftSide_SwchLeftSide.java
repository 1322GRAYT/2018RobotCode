...
/**
 * Command Group Class: AM_StrtLeftSide_SwchLeftSide
 * Autonomous Control Group Pattern: Robot Starts Left-Side
 * and Robot puts PwrCube in the Left-Side Switch.
 */
public class AM_StrtLeftSide_SwchLeftSide extends CommandGroup {
	
	
	/**
	 * Command Group Method: AM_StrtLeftSide_SwchLeftSide
     * Autonomous Control Group Pattern: Robot Starts Left-Side
     * and Robot puts PwrCube in the Left-Side Switch.
	 */	
    public AM_StrtLeftSide_SwchLeftSide() {   	
    	...
    	addSequential(new AC_TurnByGyro(0.7, 180.0, false)); // Turn CW to 180 deg
    	System.out.println("StrtLeftSide_SwchLeftSide");
    }    
