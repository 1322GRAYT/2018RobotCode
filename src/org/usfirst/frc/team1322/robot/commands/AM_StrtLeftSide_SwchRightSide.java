...
/**
 * Command Group Class: AM_StrtLeftSide_SwchRightSide
 * Autonomous Control Group Pattern: Robot Starts Left-Side
 * and Robot puts PwrCube in the Right-Side Switch.
 */
public class AM_StrtLeftSide_SwchRightSide extends CommandGroup {
	
	
	/**
	 * Command Group Method: AM_StrtLeftSide_SwchRightSide
     * Autonomous Control Group Pattern: Robot Starts Left-Side
     * and Robot puts PwrCube in the Right-Side Switch.
	 */	
    public AM_StrtLeftSide_SwchRightSide() {   	
    	...
    	addSequential(new AC_TurnByGyro(0.7, 75.0, true)); // Turn CW to 90 deg
		addSequential(new AC_TimeDelay(K_CmndCal.KCMD_t_PostMoveDly));
    	addSequential(new AC_ResetEncoders(K_CmndCal.KCMD_t_EncdrRstDly));
    	...
    	System.out.println("StrtLeftSide_SwchRightSide");
    }    
