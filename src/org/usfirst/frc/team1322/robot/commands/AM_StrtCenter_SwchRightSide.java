...
/**
 * Command Group Class: AM_StrtCenter_SwchRightSide
 * Autonomous Control Group Pattern: Robot Starts Center 
 * and Robot puts PwrCube in the Right-Side Switch.
 */
public class AM_StrtCenter_SwchRightSide extends CommandGroup {	

	
	/**
	 * Command Group Method: AM_StrtCenter_SwchRightSide
	 * Autonomous Control Group Pattern: Robot Starts Center
	 * and Robot puts PwrCube in the Right-Side Switch.
	 */	
    public AM_StrtCenter_SwchRightSide() {
    	...
    	System.out.println("StrtCenter_SwchRightSide");
    }
