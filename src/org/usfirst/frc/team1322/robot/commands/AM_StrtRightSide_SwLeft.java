 ...
 */
public class AM_StrtRightSide_SwLeft extends CommandGroup {
	

	/**
	 * Command Group Method: AM_StrtRightSide_SwLeft
     * Autonomous Control Group Pattern: Robot Starts Right-Side
     * and Robot puts PwrCube in the Left-Side Switch.
	 */	
    public AM_StrtRightSide_SwLeft() {
    	...
    	addSequential(new BM_LiftHoldPstn(K_LiftCal.KLFT_r_LiftMtrHldPwrMid)); 
    	addParallel(new AC_TurnByGyro(-K_CmndCal.KCMD_r_RotPwr90Deg, -75.0)); // Turn CCW to -90 deg       	
    	addSequential(new BM_LiftHoldPstn(K_LiftCal.KLFT_r_LiftMtrHldPwrMid)); 
		addParallel(new AC_TimeDelay(K_CmndCal.KCMD_t_PostMoveDly));
    	addSequential(new BM_LiftHoldPstn(K_LiftCal.KLFT_r_LiftMtrHldPwrMid)); 
     	addParallel(new AC_ResetEncoders(K_CmndCal.KCMD_t_EncdrRstDly));
    	...
    	addSequential(new BM_LiftHoldPstn(K_LiftCal.KLFT_r_LiftMtrHldPwrMid)); 
    	addParallel(new AC_TurnByGyro(-K_CmndCal.KCMD_r_RotPwr90Deg, -190.0)); // Turn CCW to -180 deg
    	addSequential(new BM_LiftHoldPstn(K_LiftCal.KLFT_r_LiftMtrHldPwrMid)); 
     	addParallel(new AC_TimeDelay(K_CmndCal.KCMD_t_PostMoveDly));
    	addSequential(new BM_LiftHoldPstn(K_LiftCal.KLFT_r_LiftMtrHldPwrMid)); 
	    addParallel(new AC_ResetEncoders(K_CmndCal.KCMD_t_EncdrRstDly));
    	...
    	addSequential(new BM_LiftHoldPstn(K_LiftCal.KLFT_r_LiftMtrHldPwrMid)); 
    	addParallel(new AC_TurnByGyro(-K_CmndCal.KCMD_r_RotPwr90Deg, -280.0)); // Turn CCW to -270 deg
    	addSequential(new BM_LiftHoldPstn(K_LiftCal.KLFT_r_LiftMtrHldPwrMid)); 
	    addParallel(new AC_TimeDelay(K_CmndCal.KCMD_t_PostMoveDly));
    	addSequential(new BM_LiftHoldPstn(K_LiftCal.KLFT_r_LiftMtrHldPwrMid)); 
	    addParallel(new AC_ResetEncoders(K_CmndCal.KCMD_t_EncdrRstDly));
