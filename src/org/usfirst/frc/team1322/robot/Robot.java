...
import org.usfirst.frc.team1322.robot.commands.AutoSlct_CenterPITest;
...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		...
		m_chooser.addObject("Left: Switch And Scales", new AutoSlct_LeftSide(K_CmndCal.SWITCH_AND_SCALES));
		...
		m_chooser.addObject("Right: Switch And Scales", new AutoSlct_RightSide(K_CmndCal.SWITCH_AND_SCALES));
		...
		m_chooser.addObject("TEST (Shooter)", new AM_Test_ShootBlock());
		m_chooser.addObject("TEST (C-A Drive PI)", new AutoSlct_CenterPITest());
		m_chooser.addObject("TEST (Rotate PI)", new AM_Test_RotPI());
